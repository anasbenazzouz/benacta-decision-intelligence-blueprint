...
Role 1 · HERITAGE (Libre Caslon Display) is **not** vendored: the charter
reserves it for the logo, and the logo is never re-typeset; the supplied
lockup artwork in `assets/generated/` is used instead.
