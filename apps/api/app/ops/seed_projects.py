...
from app.ops.odoo_seed_base import XMLID_MODULE, OdooSeeder, SeedReport, batched, print_report
...
class ProjectSeeder(OdooSeeder):
    def __init__(self, reader: OdooReader, writer: OdooWriter | None, company_name: str, anchor: date = DEFAULT_ANCHOR):
        ...
        super().__init__(reader, writer, company_name, extend_with_projects(build_demo_dataset(anchor=anchor)))
